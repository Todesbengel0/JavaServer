...
public class Ray {
  ...
  /**
   * This is the constructor without initialization
   */
  public Ray() {
    origin = new Vector3f();
  ...
  /**
   * This is the constructor with immediate initialization
   * 
   * @param Vector3f
   *          eyepoint
   * @param Vector3f
   ...
   */
  public boolean cast(RenderableObjList objList) {
   ...
   * @return boolean whether any object was hit
   */
  public Renderable trace(RenderableObjList objList) {
